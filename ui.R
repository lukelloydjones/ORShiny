    ...
    tabsetPanel(id = "tabset",
         tabPanel("About",
                 ...
                 p("This Shiny app accompanies the manuscript titled 
                   ...
                   logistic regression from other studies. The workflow is as follows:"),
                 ...
                 p("i) the user loads a set of summary statistics results generated from a linear mixed model GWAS analysis using the
                    ...
                    loading. If each variant or a set of variants has a different prevalence then this can be supplied with the
                    summary statistics as a new column title 'K'."),
